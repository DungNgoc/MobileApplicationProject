...
public class ScreenPlayLevel3 extends AbstractScreen{
    ...
    public void show() {
        ...
        lstAcRod.add(new ActorRod(200.0F, 80.0F, 40.0F, 30.0F, ActorRod.RodTag.DINAMOND_650));
        lstAcRod.add(new ActorRod(700.0F, 70.0F, 40.0F, 30.0F, ActorRod.RodTag.DINAMOND_650));
        lstAcRod.add(new ActorRod(710.0F, 340.0F, 40.0F, 30.0F, ActorRod.RodTag.DINAMOND_650));
        lstAcRod.add(new ActorRod(220.0F, 100.0F, 80.0F, 80.0F, ActorRod.RodTag.GOLD_500));
        //lstAcRod.add(new ActorRod(700.0F, 85.0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       F, 80.0F, 80.0F, ActorRod.RodTag.GOLD_500));
        lstAcRod.add(new ActorRod(175.0F, 200.0F, 60.0F, 50.0F, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(170.0F, 260.0F, 40.0F, 40.0F, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(170.0F, 300.0F, 60.0F, 50.0F, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(340.0F, 200.0F, 60.0F, 50.0F, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(320.0F, 275.0F, 40.0F, 40.0F, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(335.0F, 165.0F, 40.0F, 40.0F, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(275.0F, 95.0F, 40.0F, 40.0F, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(390.0F, 280.0F, 40.0F, 40.0F, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(490.0F, 300.0F, 40.0F, 40.0F, ActorRod.RodTag.GOLD_100));
        lstAcRod.add(new ActorRod(470.0F, 280.0F, 40.0F, 40.0F, ActorRod.RodTag.GOLD_100));
        lstAcRod.add(new ActorRod(655.0F, 340.0F, 40.0F, 40.0F, ActorRod.RodTag.GOLD_100));
        lstAcRod.add(new ActorRod(400.0F, 320.0F, 40.0F, 40.0F, ActorRod.RodTag.GOLD_100));
        lstAcRod.add(new ActorRod(750.0F, 385.0F, 40.0F, 40.0F, ActorRod.RodTag.GOLD_100));
        lstAcRod.add(new ActorRod(800.0F, 290.0F, 40.0F, 40.0F, ActorRod.RodTag.GOLD_100));
        lstAcRod.add(new ActorRod(830.0F, 270.0F, 40.0F, 40.0F, ActorRod.RodTag.GOLD_100));
        lstAcRod.add(new ActorRod(690.0F, 200.0F, 40.0F, 40.0F, ActorRod.RodTag.GOLD_100));
        lstAcRod.add(new ActorRod(590.0F, 200.0F, 60.0F, 60.0F, ActorRod.RodTag.GOLD_250));
        lstAcRod.add(new ActorRod(650.0F, 300.0F, 60.0F, 60.0F, ActorRod.RodTag.GOLD_250));
        lstAcRod.add(new ActorRod(715.0F, 200.0F, 60.0F, 60.0F, ActorRod.RodTag.GOLD_250));
